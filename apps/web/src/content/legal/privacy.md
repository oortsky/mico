...
- **Core Features**: Data is used to provide core functionalities, including real-time data (earthquakes, space images, etc.) and AI chatbot responses.
...
To provide real-time data (e.g., earthquake information, space images), **Mico** integrates with third-party APIs. These services may collect and provide non-personalized data (e.g., location or time of an earthquake), but no personal user data (e.g., Discord IDs) is shared with these third-party services.
...
To exercise these rights, contact us at axara@proton.me.

## 8. Changes to the Privacy Policy

We may update this Privacy Policy from time to time. Any changes will be posted here, with the date. By continuing to use **Mico** after updates, you agree to the revised policy.

## 9. Contact

For any questions or concerns regarding this Privacy Policy, feel free to reach out to us at axara@proton.me
